...
We tested our models using Cross-Entropy loss. 
...
}, showcasing their performance over the epochs. The observed discrepancy between the validation and training losses suggests that the models are overfitting to the training data. This overfitting is likely due to the relatively small size of the dataset used considering large size of the models.
